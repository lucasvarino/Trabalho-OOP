...
public class InterfaceJogadorTreinador extends javax.swing.JFrame implements InitComponents {
    ...
    private void registraTreinadorActionPerformed(java.awt.event.ActionEvent evt) {
        // manda o jogador para a InterfaceRegistraTreinador
        InterfaceCriaTreinador interfaceCriaTreinador = new InterfaceCriaTreinador();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceJogadorTreinador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
